...
document.getElementById("btn").addEventListener("click", () => {
  window.open(
    "https://drive.google.com/file/d/1Kz1WPUbnMFzvP_PGeaTzU92cHo0FVPP3/view",
    "_blank",
    "noopener,noreferrer"
  );
});
...
document
  .getElementById("learn-more-about-me-button")
...
document
  .getElementById("code-quote-button")
  .addEventListener("click", function () {
    window.open(
      "https://github.com/abhishekk119/quotegenerator",
      "_blank",
      "noopener,noreferrer"
    );
  });
...
document
  .getElementById("demo-button-quote")
  .addEventListener("click", function () {
    window.open(
      "https://abhishekk119.github.io/quotegenerator/",
      "_blank",
      "noopener,noreferrer"
    );
  });
...
document
  .getElementById("logo-button-todo")
  .addEventListener("click", function () {
    window.open(
      "https://github.com/abhishekk119/newtodo",
      "_blank",
      "noopener,noreferrer"
    );
  });
...
document
  .getElementById("demo-button-todo")
  .addEventListener("click", function () {
    window.open(
      "https://abhishekk119.github.io/newtodo/",
      "_blank",
      "noopener,noreferrer"
    );
  });
...
document
  .getElementById("code-calculator-button")
  .addEventListener("click", function () {
    window.open(
      "https://github.com/abhishekk119/calculatornew",
      "_blank",
      "noopener,noreferrer"
    );
  });
...
document
  .getElementById("demo-button-calculator")
  .addEventListener("click", function () {
    window.open(
      "https://abhishekk119.github.io/calculatornew/",
      "_blank",
      "noopener,noreferrer"
    );
  });

//code button for quiz game//
document
  .getElementById("code-quiz-button")
  .addEventListener("click", function () {
    window.open(
      "https://github.com/abhishekk119/quizgame",
      "_blank",
      "noopener,noreferrer"
    );
  });

//live demo button for quiz game//
document
  .getElementById("demo-button-quiz")
  .addEventListener("click", function () {
    window.open(
      "https://abhishekk119.github.io/quizgame/",
      "_blank",
      "noopener,noreferrer"
    );
  });
